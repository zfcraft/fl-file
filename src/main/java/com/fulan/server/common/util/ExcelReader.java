...
public class ExcelReader {
	...
	public static void main(String[] args) {
		try {
			ExcelReader eh = new ExcelReader("C:\\Users\\Administrator\\Desktop\\fulan-demo\\upload\\保单.xlsx", "保单");
			List<String> titles = eh.getTitleList(eh, 6);
			List<Object> userList = eh.getDataList(InsurEntity.class, eh, 6, 301, titles);
